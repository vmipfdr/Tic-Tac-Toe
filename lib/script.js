...
function winner() {
	...
	if (
		...
		spot[1].style.backgroundColor == "red" &&
		spot[2].style.backgroundColor == "red"
 		) {
		console.log('Player Two Wins!')
 	}
 	if (
 		spot[0].style.backgroundColor == "red" &&
 		spot[3].style.backgroundColor == "red" &&
 		spot[6].style.backgroundColor == "red"
 		) {
 		console.log('Player Two Wins!')
 	}
	if (
		spot[0].style.backgroundColor == "red" &&
 		spot[4].style.backgroundColor == "red" &&
 		spot[8].style.backgroundColor == "red"
		) {
		console.log('Player Two Wins!')
	}
	if (
		spot[1].style.backgroundColor == "red" &&
 		spot[4].style.backgroundColor == "red" &&
 		spot[7].style.backgroundColor == "red"
		) {
		console.log('Player Two Wins!')
	}
	if (
		spot[2].style.backgroundColor == "red" &&
 		spot[5].style.backgroundColor == "red" &&
 		spot[8].style.backgroundColor == "red"
		) {
		console.log('Player Two Wins!')
	}
